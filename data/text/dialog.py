...
class Dialog:
    ...
    def king_lorik_initial_dialog(self):
        ...
        print_with_beep_sfx(f"'Now, {self.player_name}, thou must help us recover the Ball of Light and restore peace to our land.'")
        ...
        print_with_beep_sfx(f"'May the light shine upon thee, {self.player_name}.'")
    ...
    def king_lorik_spoken_to_dialog(self):
        ...
        if door_locked:
            ...
            points_remaining_to_next_level = 10
            print_with_beep_sfx(f"'I am greatly pleased that thou hast returned, {self.player_name}.'")
            print_with_beep_sfx(f"'Before reaching thy next level of experience thou must gain {points_remaining_to_next_level} Points.'")
            ...
            if continuing == "Y":
                print_with_beep_sfx(f"'Goodbye now, {self.player_name}.\n'Take care and tempt not the Fates.'")
            elif continuing == "N":
    ...
    def right_face_guard_tantegel_throne_room(self):
        ...
        print_with_beep_sfx(f"'Return to the Inn for a rest if thou art wounded in battle, {self.player_name}.'")
    ...
    def roaming_guard_tantegel_throne_room(self):
        ...
        if not know_about_princess:
            ...
            print_with_beep_sfx(f"'{self.player_name}, please save the Princess.'")
