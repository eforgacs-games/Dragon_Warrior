...
NAME_SELECTION_QUESTION_MARK = join(NAME_SELECTION_DIR, '29_?.png')
...
NAME_SELECTION_LOWER_B = join(NAME_SELECTION_DIR, '34_a.png')
NAME_SELECTION_LOWER_C = join(NAME_SELECTION_DIR, '35_a.png')
NAME_SELECTION_LOWER_D = join(NAME_SELECTION_DIR, '36_a.png')
NAME_SELECTION_LOWER_E = join(NAME_SELECTION_DIR, '37_a.png')
NAME_SELECTION_LOWER_F = join(NAME_SELECTION_DIR, '38_a.png')
NAME_SELECTION_LOWER_G = join(NAME_SELECTION_DIR, '39_a.png')
NAME_SELECTION_LOWER_H = join(NAME_SELECTION_DIR, '40_a.png')
NAME_SELECTION_LOWER_I = join(NAME_SELECTION_DIR, '41_a.png')
NAME_SELECTION_LOWER_J = join(NAME_SELECTION_DIR, '42_a.png')
NAME_SELECTION_LOWER_K = join(NAME_SELECTION_DIR, '43_a.png')
NAME_SELECTION_LOWER_L = join(NAME_SELECTION_DIR, '44_a.png')
NAME_SELECTION_LOWER_M = join(NAME_SELECTION_DIR, '45_a.png')
NAME_SELECTION_LOWER_N = join(NAME_SELECTION_DIR, '46_a.png')
NAME_SELECTION_LOWER_O = join(NAME_SELECTION_DIR, '47_a.png')
NAME_SELECTION_LOWER_P = join(NAME_SELECTION_DIR, '48_a.png')
NAME_SELECTION_LOWER_Q = join(NAME_SELECTION_DIR, '49_a.png')
NAME_SELECTION_LOWER_R = join(NAME_SELECTION_DIR, '50_a.png')
NAME_SELECTION_LOWER_S = join(NAME_SELECTION_DIR, '51_a.png')
NAME_SELECTION_LOWER_T = join(NAME_SELECTION_DIR, '52_a.png')
NAME_SELECTION_LOWER_U = join(NAME_SELECTION_DIR, '53_a.png')
NAME_SELECTION_LOWER_V = join(NAME_SELECTION_DIR, '54_a.png')
NAME_SELECTION_LOWER_W = join(NAME_SELECTION_DIR, '55_a.png')
NAME_SELECTION_LOWER_X = join(NAME_SELECTION_DIR, '56_a.png')
NAME_SELECTION_LOWER_Y = join(NAME_SELECTION_DIR, '57_a.png')
NAME_SELECTION_LOWER_Z = join(NAME_SELECTION_DIR, '58_a.png')
...
NAME_SELECTION_STATIC_IMAGE = join(NAME_SELECTION_DIR, '63_static_image.png')
